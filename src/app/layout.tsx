...
export const metadata: Metadata = {
  title: {
    default: "MUZIMPE Life & Growth Ltd | EBGS Natural Wellness in Kigali",
    template: "%s | MUZIMPE Life & Growth Ltd",
  },
  description:
    "Promoting health, wellness, natural living, entrepreneurship, family guidance, and life growth through EBGS in Kigali.",
};
