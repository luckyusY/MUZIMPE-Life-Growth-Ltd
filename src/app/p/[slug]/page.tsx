...
const helpCards = [
  ...
  },
  {
    ...
    body: "Visit MUZIMPE at BH Plaza in Kigali for products, guidance, pickup, and support.",
    icon: Building2,
    href: MAPS_URL,
  },
];
    ...
    <aside className="no-scrollbar sticky top-[72px] z-20 self-start overflow-y-auto bg-white md:top-32 md:max-h-[calc(100vh-8.5rem)]">
      <div className="border border-[#e7ddc7] bg-white p-3 shadow-sm">
        ...
        >
          ...
          <span>
            <strong className="block text-[#8b641e]">Ask before you buy</strong>
            Get MUZIMPE product guidance by phone or WhatsApp.
          </span>
        </Link>
        ...
        <div className="mt-4">
          ...
          {[
            ...
            ["2-Session MUZIMPE Support", protectionBase * 2],
            ["3-Session MUZIMPE Support", protectionBase * 3],
          ].map(([label, price]) => (
            <label
              key={String(label)}
      ...
      <div className="mx-auto max-w-[1340px] px-3 py-3 sm:px-4">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
            <div className="space-y-5 text-[15px] leading-7 text-[#333]">
              <div>
                ...
                <p className="mt-2">
                  This product is selected for Rwanda-based wellness customers,
                  families, and entrepreneurs who need natural products with
                  local support. It pairs practical use, guidance, and pickup
                  support from MUZIMPE in Kigali.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-black">
        ...
        <section id="reviews" className="mt-10 scroll-mt-44">
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[340px_minmax(0,1fr)]">
            ...
            <div className="text-sm leading-7 text-[#333]">
              <p>
                Ratings are collected from verified MUZIMPE customers in store
                and after delivery. Customer feedback helps wellness customers
                in Rwanda choose the right products with confidence.
              </p>
              <Link
                href="/support"
        ...
        <section id="qa" className="mt-10 scroll-mt-44">
          ...
          <div className="mt-4 grid gap-6 text-sm leading-6 text-[#333] lg:grid-cols-2">
            ...
            <div>
              <h3 className="font-bold text-black">Q: Is guidance included?</h3>
              <p>
                A: Yes. MUZIMPE can guide product selection and usage questions
                through the Kigali store, phone, WhatsApp, or email.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-black">
