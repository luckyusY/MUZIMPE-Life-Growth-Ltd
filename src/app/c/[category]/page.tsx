...
function DepartmentPage({
  ...
  return (
    <main className="bg-[#f1f1f1] text-black">
      ...
      <PromoBand
        title={displayName}
        body={`${displayBlurb} Shop top-rated picks with MUZIMPE guidance and Kigali support.`}
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 text-[13px] leading-6 text-[#333]">
        <h2 className="mb-3 text-base font-black">
          Shop MUZIMPE for the Best in {displayName}
        </h2>
        <p>{displayBlurb}</p>
        <p className="mt-4">
          Browse trusted gear with local support, fast Kigali delivery, and
          in-store pickup. Every order is supported by MUZIMPE&apos;s Rwanda
          team and clear product guidance.
        </p>
      </section>
