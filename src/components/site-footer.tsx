...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      { label: "EBGS Wellness", href: "/c/wellness" },
      { label: "Natural Living", href: "/c/herbal-care" },
      { label: "Family Guidance", href: "/c/family-guidance" },
      { label: "Entrepreneurship Support", href: "/c/entrepreneurship" },
      { label: "Life Growth", href: "/c/life-growth" },
      { label: "Product Guidance", href: "/support" },
      { label: "Kigali Pickup", href: "/stores" },
  ...
  },
  {
    title: "Who We Are",
    links: [
      { label: "About MUZIMPE", href: "/about" },
      { label: "Our Store", href: "/stores" },
      { label: "Map & Directions", href: "/stores" },
      { label: "Wellness Support", href: "/support" },
  ...
  },
  {
    title: "Shop",
    links: [
      { label: "Natural Oils", href: "/c/natural-oils" },
      { label: "Wellness", href: "/c/wellness" },
      { label: "Herbal Care", href: "/c/herbal-care" },
      { label: "Family Guidance", href: "/c/family-guidance" },
      { label: "Entrepreneurship", href: "/c/entrepreneurship" },
      { label: "Life Growth", href: "/c/life-growth" },
    ...
    <footer className="bg-[#050505] pb-24 text-white md:pb-0">
      ...
      <div className="border-b border-[#d9a441]/25 bg-[#15110a]">
        <div className="mx-auto grid max-w-7xl gap-5 px-4 py-7 md:grid-cols-[1fr_minmax(0,480px)] md:items-center md:py-8">
          <div>
            <p className="text-lg font-black sm:text-xl">Stay Connected with MUZIMPE</p>
            <p className="mt-1 max-w-xl text-sm leading-6 text-white/70">
              Sign up for product updates, natural wellness guidance, EBGS
              offers, and Kigali pickup or delivery news.
            </p>
          </div>
          <NewsletterSignup />
        </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-7 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            <div className="leading-none">
              <p className="text-2xl font-black tracking-wide text-[#ffcf57]">
                MUZIMPE
              </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-8">
            ...
            <div className="flex items-center gap-2 rounded border border-white/20 bg-white/5 px-3 py-2">
              ...
              <span className="text-xs font-bold leading-4">
                Trusted in Kigali
                <br />
                <span className="text-white/60">Natural wellness &amp; guidance</span>
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#15110a]">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-5 text-xs text-white/60 md:flex-row md:items-center md:justify-between">
          <p>© 2026 MUZIMPE Life & Growth Ltd. All rights reserved.</p>
